            ...
            <form method="GET" class="row g-3">
                ...
                <div class="col-md-3">
                    <select name="credit_filter" class="form-select">
                        ...
                        <option value="empty" {{ request('credit_filter') == 'empty' ? 'selected' : '' }}>Kredit Habis (0)</option>
                        <option value="low" {{ request('credit_filter') == 'low' ? 'selected' : '' }}>Kredit Kritis (1-5)</option>
                        <option value="high" {{ request('credit_filter') == 'high' ? 'selected' : '' }}>Kredit Tinggi (>50)</option>
                    </select>
                </div>
                <div class="col-md-2">

                            ...
                            <div class="mb-3">
                                ...
                                <div class="progress" style="height: 10px;">
                                    @php
                                        $percentage =
                                            $stats['total_users'] > 0
                                                ? ($credit->count / $stats['total_users']) * 100
                                                : 0;
                                    @endphp
                ...
                <div class="card border-0 shadow-sm ">
                    ...
                    <div class="card-body">
                        <div class="alert alert-info flex-column">
                            <h6 class="mb-0"><i class="bi bi-info-circle me-2"></i>Sistem Kredit Aktif</h6>
                            <p class="mb-0 small">Guru membutuhkan 1 kredit untuk setiap paket tes yang dibuat. Kredit dapat
                                dibeli melalui menu Kredit di dashboard guru.</p>
                        </div>
                        <div class="alert alert-success flex-column">
                            <h6 class="mb-0"><i class="bi bi-check-circle me-2"></i>Sistem Approval</h6>
                                    ...
                                    @foreach ($topTeachers as $index => $teacher)
                                        <tr>
                                            ...
                                            <td><span class="badge bg-warning text-dark"><i
                                                        class="bi bi-coin me-1"></i>{{ $teacher->credits ?? 0 }}</span>
                                            </td>

    ...
    <nav class="sidebar-nav">
        <div class="sidebar-section">
            ...
            @if($role === 'admin')
                ...
                <a class="sidebar-link {{ request()->routeIs('admin.analytics.*') ? 'active' : '' }}" href="{{ route('admin.analytics.index') }}">
            ...
            @elseif($role === 'guru')
                ...
                <a class="sidebar-link {{ request()->routeIs('guru.questions.*') ? 'active' : '' }}" href="{{ route('guru.questions.index') }}">
                    <i class="bi bi-question-circle"></i> Bank Soal
                </a>
                <a class="sidebar-link {{ request()->routeIs('guru.packages.*') ? 'active' : '' }}" href="{{ route('guru.packages.index') }}">
            ...
            @elseif($role === 'student')
                ...
                <a class="sidebar-link {{ request()->routeIs('student.test.*') ? 'active' : '' }}" href="{{ route('student.test.history') }}">

                                        ...
                                        <div class="card h-100 border {{ session('selected_package_id') == $package->id ? 'border-primary' : '' }}"
                                            ...
                                            <div class="card-body text-center">
                                                ...
                                                @if ($package->bonus_credits > 0)
                                                    <div class="mt-2">
                                                        <span class="badge bg-success">+{{ $package->bonus_credits }}
                                                            Bonus</span>
                                                    </div>
                                                    <div class="mt-1">
                                                        <small class="text-success">Total:
                                                            {{ $package->getTotalCredits() }} Kredit</small>
                                                    </div>
                                                @endif
                                            ...
                                            <div class="card-footer bg-white text-center">
                                                <button type="button" class="btn btn-outline-primary btn-sm select-btn"
                ...
                <div class="card border-0 shadow-sm sticky-top" style="top: 20px;">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('guru.credits.purchase') }}" id="purchase-form">
                            ...
                            <div id="package-detail" class="border d-none bg-light p-3 mb-3 rounded-3">
                            ...
                            <div class="alert alert-info mb-3 flex-column">
